...
from utils import read_nli, attention_visualization, load_configurations, \
...
def evaluate(test_loc, max_length, bert_tf_hub, model_type):
    ...
    model = load_model(configs[model_type] + "model.h5", custom_objects={"tf": tf, "KerasLayer": hub.KerasLayer})
...
def main():
    if args.mode == "evaluate":
        ...
        premise, hypothesis = read_test_json(
            path="/media/ulgen/Samsung/contradiction_data/results/evaluation_contradiction.jsonl")
