...
#
#     # if os.path.isfile(id_save_path + "train_x_ids.pkl"):
#     #     print("train_ids_exist")
#     # else:
#     #     with open(id_save_path + "train_x_ids.pkl", 'wb') as f:
#     #         pickle.dump(features, f)
#
#     checkpoint_path = path + "bert_model.ckpt"
#
#     word_weights = print_tensors_in_checkpoint_file(file_name=checkpoint_path,
